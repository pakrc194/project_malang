...
CREATE TABLE USER_INFO (
    ...
    user_email VARCHAR(100) COMMENT '로그인 ID 및 이메일 (탈퇴 시 NULL)',
...
CREATE TABLE ACTOR_INFO (
    ...
    actor_birth_year YEAR NOT NULL COMMENT '출생년도',
    actor_gender ENUM('M', 'F') NOT NULL COMMENT '성별',
    actor_profile_url VARCHAR(255) COMMENT '프로필 이미지 URL'
);
