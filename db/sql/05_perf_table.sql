...
CREATE TABLE CAST (
    ...
    FOREIGN KEY (perf_id) REFERENCES PERFORMANCE(perf_id) ON DELETE CASCADE 
);

-- 7. PERF_CAST (공연 기본 캐스팅) - CASCADE 적용
...
-- 11. PERF_SCHEDULE (공연 스케줄) - CASCADE 적용
...
-- 12. SCHEDULE_CAST (스케줄별 최종 캐스팅) - CASCADE 적용
